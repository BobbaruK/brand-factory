...
export default function formFieldsTranslations(
  ...
  return {
    ...
    riskESMA_CYSEC: {
      en: `Trading CFDs is risky. You can lose all your invested capital.`,
      it: `Il trading di CFD è rischioso. Puoi perdere tutto il capitale investito.`,
      tr: `CFD ticareti risklidir. Yatırım yaptığınız tüm sermayenizi kaybedebilirsiniz.`,
      ro: `Tranzacționarea CFD-urilor este riscantă. Puteți pierde tot capitalul investit.`,
      ...
      es: `Operar con CFD es arriesgado. Puede perder todo su capital invertido.`,
      sv: `Handel med CFD:er är riskfyllt. Du kan förlora hela ditt investerade kapital.`,
      ...
      hu: `A CFD-kereskedés kockázatos. Elveszítheti a teljes befektetett tőkét.`,
    ...
    riskESMA_FSA: {
      en: `Trading CFDs is risky.`,
      it: `Il trading di CFD è rischioso.`,
      tr: `CFD işlemleri risklidir.`,
      ro: `Tranzacționarea CFD-urilor este riscantă.`,
      ar: `تداول عقود الفروقات محفوف بالمخاطر.`,
      de: `Der Handel mit CFDs ist riskant.`,
      es: `Operar con CFD es arriesgado.`,
      sv: `Handel med CFD:er är riskfyllt.`,
      pt: `Negociar CFDs é arriscado.`,
      fi: `CFD-kaupankäynti on riskialtista.`,
      pl: `Handel kontraktami CFD jest ryzykowny.`,
      hu: `A CFD-kereskedés kockázatos.`,
      th: `การซื้อขาย CFD มีความเสี่ยง`,
      ms: `Perdagangan CFD adalah berisiko.`,
